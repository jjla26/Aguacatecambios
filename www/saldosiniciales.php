...
$insertar = "INSERT INTO saldos1 (saldo_efec, saldo_rut, saldo_vista, saldo_ahorro, saldo_mercantil_mariana, saldo_mercantil_carlos, saldo_mercantil_juridica, saldo_banesco_carlos, saldo_banesco_marola, saldo_banesco_sonalys, saldo_banesco_juridica, disp_mercantil_mariana, disp_mercantil_carlos, disp_mercantil_juridica, disp_banesco_carlos, disp_banesco_marola, disp_banesco_sonalys, disp_banesco_juridica, Fecha) VALUES ('$inicial_efec','$inicial_rut','$inicial_vista','$inicial_ahorro','$inicial_mercantil_mariana','$inicial_mercantil_carlos','$inicial_mercantil_juridica','$inicial_banesco_carlos','$inicial_banesco_marola','$inicial_banesco_sonalys','$inicial_banesco_juridica','$inicial_mercantil_mariana','$inicial_mercantil_carlos','$inicial_mercantil_juridica','$inicial_banesco_carlos','$inicial_banesco_marola','$inicial_banesco_sonalys','$inicial_banesco_juridica','$current_date')";
